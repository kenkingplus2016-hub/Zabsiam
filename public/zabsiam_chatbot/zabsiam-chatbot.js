(function{
 ...
 if (/price|cost|how much/.test(q)) return 'Prices:<br>• Event Catering: From £15 to £41 per guest (depending on menu & guest count)<br>• Signature Box: £14 - £25 (Crispy Pork Belly)<br>For exact quotes, please contact us directly.';
