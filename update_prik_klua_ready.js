...
if (index !== -1) {
    data[index].desc.en = data[index].desc.en.replace(
        'Signature Box: Spicy Chilli & Salt Stir Fry',
        'Ready-to-eat Signature Box: Spicy Chilli & Salt Stir Fry'
    );
    fs.writeFileSync(file, JSON.stringify(data, null, 2), 'utf8');
    console.log("Updated Prik Klua Box desc to add Ready-to-eat.");
} else {
