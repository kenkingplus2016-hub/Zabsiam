...
const regex = /<h4 style="color: var\(--color-gold\); font-size: 1\.5rem; margin-bottom: 5px;">Royal Thai Premium<\/h4>[\s\S]*?<\/ul>/;

const newHTML = `<h4 style="color: var(--color-gold); font-size: 1.5rem; margin-bottom: 5px;">Royal Thai Premium</h4>
...
console.log('Updated Royal Thai Premium package items.');
